...
// CONCATENATED MODULE: ./node_modules/history/index.js
			...
			function createBrowserHistory(b) {
				...
				function x(c, a) {
					void 0 === a && (a = null);
					return C(Object(esm_extends["a" /* default */])({
						pathname: q.pathname,
						hash: "",
						search: ""
					}, "string" === typeof c ? J(c) : c, {state: a, key: H()}))
				}
				...
				function A(c, a) {
					...
					var l = r.Push, k = x(c,
						a);
					if (!g.length || (g.call({action: l, location: k, retry: f}), !1)) {
				...
				function y(c, a) {
					...
					g.length && (g.call({action: l, location: k, retry: f}), 1) || (k = [{
						usr: k.state,
						key: k.key,
						idx: v
  ...
  if (false) {}
	...
	reinitializeEditor(target, settings);
		...
		/***/ (function (module, __webpack_exports__, __webpack_require__) {
			...
			"use strict";
			/* harmony import */
			var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("GRId");
			/* harmony import */
			...
			/* harmony import */
			var _wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("Tqx9");
			/* harmony import */
			...
			/* harmony default export */
			__webpack_exports__["a"] = (external);
